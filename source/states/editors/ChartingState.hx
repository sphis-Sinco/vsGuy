...
class ChartingState extends MenuState implements PsychUIEventHandler.PsychUIEvent
{
	...
	override function create()
	{
		...
		var gameOverCharacters:Array<String> = CoolUtil.loadFileList('data/characters/', 'data/characterList.txt');
	...
	function addMetadataTab()
	{
		...
		dialogue = new PsychUICheckBox(ratingInput.x, characterName.y + y_pad_checkbox, "Dialogue File?", 100);
		censoredDialogue = new PsychUICheckBox(dialogue.x + x_pad_checkbox, dialogue.y, "Censored Dialogue File?", 100);
		freeplayDialogue = new PsychUICheckBox(ratingInput.x, dialogue.y + y_pad_checkbox, "Dialogue in Freeplay", 100);
		endDialogue = new PsychUICheckBox(freeplayDialogue.x + x_pad_checkbox, freeplayDialogue.y, "End of Song Dialogue File?", 100);
