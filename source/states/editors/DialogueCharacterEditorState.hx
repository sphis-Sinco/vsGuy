...
class DialogueCharacterEditorState extends MenuState implements PsychUIEventHandler.PsychUIEvent
{
	var box:FlxSprite;
	...
	override function update(elapsed:Float)
	{
		...
		if (PsychUIInputText.focusOn == null)
		{
			...
			if ((FlxG.keys.justPressed.SPACE #if TOUCH_CONTROLS_ALLOWED || touchPad.buttonA.justPressed #end)
				&& UI_mainbox.selectedName == 'Character')
			{
