...
class ClientPrefs
{
	...
	public static function resetSave()
	{
		...
		data.dynamicColors = true; // yes cause its cool -Karim
		data.controlsAlpha = FlxG.onMobile ? 0.6 : 0;
		data.screensaver = false;
		data.wideScreen = false;
		#if android
		data.storageType = "EXTERNAL_DATA";
		#end
		data.hitboxType = "Gradient";
		data.popUpRating = true;
		data.vsync = false;
		data.vibrating = false;

		data.favSongIds = [];
		data.lastFreeplayMod = '||bf';

		data.downScroll = false;
		data.middleScroll = false;
		data.opponentStrums = true;
		data.showFPS = true;
		data.flashing = true;
		data.autoPause = true;
		data.antialiasing = true;
		data.noteSkin = 'Default';
		data.splashSkin = 'Psych';
		data.holdSkin = 'Vanilla';
		data.splashAlpha = 0.6;
		data.holdSplashAlpha = 0.6;
		data.lowQuality = false;
		data.shaders = true;
		data.cacheOnGPU = #if !switch false #else true #end; // From Stilic
		data.framerate = 60;
		data.camZooms = true;
		data.hideHud = false;
		data.vsliceFreeplayColors = true;
		data.vsliceResults = true;
		data.vsliceSpecialCards = true;
		data.vsliceSmoothBar = true;
		data.noteOffset = 0;
		data.arrowRGB = [
			[0xFFC24B99, 0xFFFFFFFF, 0xFF3C1F56],
			[0xFF00FFFF, 0xFFFFFFFF, 0xFF1542B7],
		...
		data.ghostTapping = true;
		data.timeBarType = 'Time Left';
		data.scoreZoom = true;
		data.noReset = false;
		data.healthBarAlpha = 1;
		data.hitsoundVolume = 0;
		data.pauseMusic = 'Tea Time';
		data.checkForUpdates = true;
		data.comboStacking = true;
		...
		data.comboOffset = [0, 0, 0, 0];
		data.ratingOffset = 0;
		data.sickWindow = 45;
		data.goodWindow = 90;
		data.badWindow = 135;
		data.safeFrames = 10;
		data.guitarHeroSustains = true;
